...
public void sendDisconnect(){
    ...
    try{
        ...
        ta_chat.append("tidak terhubung ke pesan... \n"); 
    }
}

public void Disconnect(){
    try{
        ta_chat.append("Disconnect. \n");
        sock.close();
    } catch(Exception ex){
        ta_chat.append("gagal ke disconnect \n");
    }
    isConnected = false;
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(tf_port, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(25, 25, 25)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(tf_chat, javax.swing.GroupLayout.PREFERRED_SIZE, 370, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(b_send)))
    ...
    private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_connectActionPerformed
        ...
        if (isConnected == false){
            ...
            try
            {
                ...
                writer.println(username + ":has connecter. :Connect");
                writer.flush();
                isConnected = true;
    ...
    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_anonymousActionPerformed
        ...
        if (isConnected == false){
            ...
            try{
                ...
                ta_chat.append("tidak bisa konek coba lagi \n");
                tf_username.setEditable(true);
            }
            ListenThread();
        }else if (isConnected == true){
            ta_chat.append("anda sudah konek");
        }
